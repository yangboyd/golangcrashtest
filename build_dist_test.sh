...
tags=""
ldflags=" -linkmode external -extldflags \" -static -L /home/byang/crashtest -ltest \"  -X tailscale.com/version.Long=${LONG} -X tailscale.com/version.Short=${SHORT} -X tailscale.com/version.GitCommit=${GIT_HASH}"
...
exec ./tool/go build  -x ${tags:+-tags=$tags} -ldflags "$ldflags" "$@"
